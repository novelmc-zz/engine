...
public class Command_staffchat extends CommandBase
{
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String string, String[] args)
    {
        ...
        NUtil.globalMessage(NUtil.colorize("&8<-> &4&lSTAFF &r&8» &7" + Rank.getDisplay(sender).getTag() + " &7" + sender.getName() + "&8: ") + ChatColor.GOLD + StringUtils.join(args, " ", 0, args.length), NUtil.MessageType.STAFF_ONLY);
        return true;
    }
}
