...
public class Command_busy extends CommandBase
{
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String string, String[] args)
    {
        ...
        {
            NUtil.globalMessage(NUtil.colorize("&8<-> &9&lSERVER&r&8 \u00BB &7" + sender.getName() + " is no longer marked as busy."), NUtil.MessageType.ALL);
            NPlayer.busyPlayers.remove(player);
            return true;
        }
        NUtil.globalMessage(NUtil.colorize("&8<-> &9&lSERVER&r&8 \u00BB &7" + sender.getName() + " is now marked as busy."), NUtil.MessageType.ALL);
